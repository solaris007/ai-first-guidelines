...
This guide defines AI-native skill expectations for engineering managers across four bands: M2-M3, M4, M5, and M6. It complements - not replaces - the existing ESDEM leveling guide. The standard guide defines the full role expectations; this guide adds the AI-native dimension.
...
**AI-native skills compound.** Each band builds on the prior. The matrix cells describe what is new at each band, not the full set of expectations. An M6 is expected to demonstrate M2-M5 behaviors as well.
